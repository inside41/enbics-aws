...
public class PaginationInfo {
	...
	public PaginationInfo(Pagination pagination) {
		...
		if (pagination.getRecordsPerPage() < 1 || pagination.getRecordsPerPage() > 100) {
			pagination.setRecordsPerPage(10);
		}
		if (pagination.getPageSize() < 5 || pagination.getPageSize() > 20) {
	...
	public void setTotalRecordCount2(int totalRecordCount) {
		this.totalRecordCount = totalRecordCount;
